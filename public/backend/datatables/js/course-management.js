...
$(function () {
    ...
    var dt_category_table = $('.datatables-courses'),
        select2 = $('.select2'),
        sub_select2 = $('.select2_sub'),
        categoryView = baseUrl + '/admin/api-courses',
        offCanvasForm = $('#offcanvasAddCourse');
    ...
    $('.add-new').on('click', function () {
        $('#course_id').val(''); //reseting input field
        $('#offcanvasAddCourseLabel').html(addNewTranslation);
    });
    ...
    const fv = FormValidation.formValidation(addNewCourseForm, {
        fields: {
            name_en: {
                validators: {
                    notEmpty: {
